...
These tools are **not meant to be run again**. They are kept for reference: the paths they proved out, the engine facts they encode, and the functions worth harvesting into generalized RM tooling later.
